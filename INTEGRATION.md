...
at [`wasmd/app/app.go`](https://github.com/noria-net/ibc-hooks/blob/master/app/app.go#)
...
ante handlers into the `ante handler chain` as in: [`app/ante.go`](https://github.com/noria-net/ibc-hooks/blob/master/app/ante.go)
...
If you look at the unit tests in [`x/wasm/internal/keeper`](https://github.com/noria-net/ibc-hooks/tree/master/x/wasm/internal/keeper),
...
[`CustomQuerier`](https://github.com/noria-net/ibc-hooks/blob/v0.8.0-rc1/x/wasm/internal/keeper/query_plugins.go#L35),
which allows you to handle your custom queries. The second is 
[`CustomEncoder`](https://github.com/noria-net/ibc-hooks/blob/v0.8.0-rc1/x/wasm/internal/keeper/handler_plugin.go#L30)
...
In particular, here [we define a `CustomQuerier`](https://github.com/noria-net/ibc-hooks/blob/v0.8.0-rc1/x/wasm/internal/keeper/reflect_test.go#L355-L385),
and here [we define a `CustomHandler`](https://github.com/noria-net/ibc-hooks/blob/v0.8.0-rc1/x/wasm/internal/keeper/reflect_test.go#L303-L353).
...
[encode staking messages](https://github.com/noria-net/ibc-hooks/blob/v0.8.0-rc1/x/wasm/internal/keeper/handler_plugin.go#L114-L192).
Note that withdraw returns 2 messages, which is an option you can use if needed to translate into native messages.
When we [handle staking queries](https://github.com/noria-net/ibc-hooks/blob/v0.8.0-rc1/x/wasm/internal/keeper/query_plugins.go#L109-L172)
...
[define the supported feature set](https://github.com/noria-net/ibc-hooks/blob/ade03a1d39a9b8882e9a1ce80572d39d57bb9bc3/x/wasm/internal/keeper/reflect_test.go#L52)
to include your custom name (remember `requires_XYZ` above?). Then, when creating `TestInput`, 
you can [pass in your custom encoder and querier](https://github.com/noria-net/ibc-hooks/blob/ade03a1d39a9b8882e9a1ce80572d39d57bb9bc3/x/wasm/internal/keeper/reflect_test.go#L52).
...
Just edit [the default `NewKeeper` constructor](https://github.com/noria-net/ibc-hooks/blob/v0.8.0-rc1/app/app.go#L257-L258)
